...
exports.addProductToCart = exports.getCartInRange = exports.sortCarts = exports.userCart = exports.deleteSingleCart = exports.updateSingleCart = exports.getAllCart = exports.getSingleCart = exports.addCart = void 0;
...
const addProductToCart = async (req, res) => {
    ...
    try {
        const result = await (0, cart_services_1.addProductToCartService)(userID, productId, quantity);
        res.status(200).json({ result });
    }
    catch (err) {
